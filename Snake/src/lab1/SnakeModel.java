...
public class SnakeModel extends GameModel {
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(Color.black);//color change to black

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(Color.black); //color change to black
